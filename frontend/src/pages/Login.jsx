    ...
    <AuthLayout>
      <div className="w-full max-w-[420px] flex flex-col gap-8">
        ...
        <form className="flex flex-col gap-5" onSubmit={activeTab === 'password' ? handlePasswordLogin : handleOTPLogin}>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium" htmlFor={activeTab === 'password' ? 'username' : 'mobile'}>
              {activeTab === 'password' ? 'Username or Email' : 'Mobile Number'}
            </label>
            <div className="relative flex items-center">
              ...
              <input
                id={activeTab === 'password' ? 'username' : 'mobile'}
                name={activeTab === 'password' ? 'username' : 'mobile'}
                type={activeTab === 'password' ? 'text' : 'tel'}
                placeholder={activeTab === 'password' ? 'Enter your username or email' : 'Enter your mobile number'}
                value={activeTab === 'password' ? formData.username : formData.mobile}
